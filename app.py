    ...
    with col2:
        ...
        with tab_signup:
            ...
            if st.button("Create Account", use_container_width=True):
                ...
                elif not email_pattern.match(new_email.strip()):
                    st.error("Please enter a valid email address (e.g. thanush@gmail.com).")
        ...
        if google_configured:
            ...
            st.markdown(f"""
            <div style="display:flex;align-items:center;gap:8px;margin:0.85rem 0 0.75rem">
              <div style="flex:1;height:1px;background:#2a2a50"></div>
              <span style="color:#6b7194;font-size:0.75rem">or continue with</span>
              <div style="flex:1;height:1px;background:#2a2a50"></div>
            </div>
